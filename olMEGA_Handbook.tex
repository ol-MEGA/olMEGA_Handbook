...
\begin{center}
	...
	\texttt{
		\begin{tabularx}{\textwidth}{l|l|X} 
			Type & \# & Contents\\
			\hline
			int32 & 1 & protocol version\\
			int32 & 1 & block count\\
			int32 & 1 & feature dimensions\\
			int32 & 1 & block size\\
			int32 & 1 & hop size\\
			int32 & 1 & audio sampling rate\\
			byte & 16 & time stamp (yyMMdd\_HHmmssSSS)\\
			float & 1 & calibration value in dB, channel 1\\
			float & 1 & calibration value in dB, channel 2\\
		\end{tabularx}
		}
	\end{tcolorbox}
\end{center}
